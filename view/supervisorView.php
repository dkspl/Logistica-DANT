...
<div class="w3-row-padding w3-padding-16">
    ...
    <div class="w3-container">
        ...
        <a href="/Supervisor/startTravelForm" class="w3-half">
            <div class="w3-container w3-orange w3-text-white w3-padding-16">
                ...
                <h4 class="w3-center">Cargar Viaje</h4>
            </div>
        </a>
        <a href="/Supervisor/travels" class="w3-half">
            <div class="w3-container w3-blue w3-padding-16">
                ...
                -->
                <div class="w3-clear"></div>
                <h4 class="w3-center">Viajes</h4>
            </div>
        </a>
        <a href="/Supervisor/vehiculos" class="w3-half">
